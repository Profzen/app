      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRightIcons}>
            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#F1F5F9', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 16, marginRight: 8 }} onPress={toggleLanguage}>
                <Text style={{ fontSize: 12, fontWeight: '700', color: '#1A2840', marginRight: 4 }}>{language.toUpperCase()}</Text>
                <Image source={{ uri: `https://flagcdn.com/w40/${getFlagCode(language)}.png` }} style={{ width: 16, height: 12, borderRadius: 2 }} />
              </TouchableOpacity>
